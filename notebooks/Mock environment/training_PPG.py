...
from stable_baselines3 import PPO as PPG  # Use PPG model (since it is based on PPO)
...
def objective(trial):
    ...
    # Define the PPG model with the hyperparameters from Optuna
    model = PPG(
...
# Train the final PPG agent with the optimized hyperparameters
model.learn(total_timesteps=50000)

# Save the model
model.save("ppg_acc_model_full")

# Load the model
model = PPG.load("ppg_acc_model_full", env=env)
