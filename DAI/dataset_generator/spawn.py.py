...
def main():
    ...
    argparser.add_argument(
        ...
        default=75,
        type=int,
        help="number of walkers (default: 75)",
    )
    argparser.add_argument(
    ...
    try:
        ...
        for n, transform in enumerate(spawn_points):
            ...
            if (
                blueprint.tags[0] != "crossbike"
                and blueprint.tags[0] != "low rider"
                and blueprint.tags[0] != "ninja"
                and blueprint.tags[0] != "yzf"
                and blueprint.tags[0] != "century"
                and blueprint.tags[0] != "omafiets"
                and blueprint.tags[0] != "diamondback"
                and blueprint.tags[0] != "carlacola"
            ):
